...
public class PaymentsController(IPaymentService paymentService,
    ...
    // Send notifications outside of the hub
    IHubContext<NotificationHub> hubContext) : BaseApiController
{
    ...
    public async Task<ActionResult<ShoppingCart>> CreateOrUpdatePaymentIntent(string cartId)
    {
        ...
        if (cart == null)
        {
            return BadRequest("Problem with yoour cart");
    ...
    public async Task<IActionResult> StripeWebhook()
    {
        ...
        try
        {
            ...
            await HandlePaymentIntentSucceedes(intent);
    ...
    private async Task HandlePaymentIntentSucceedes(PaymentIntent intent)
    {
